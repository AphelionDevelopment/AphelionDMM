...
func TestDecodeManifestRejectsMissingRequiredValues(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "go", manifest: `{"rust":"1.82.0","rust_target":"x86_64-pc-windows-gnu","task_major":3,"golangci_lint":"2.12.2"}`, missing: "go"},
		{name: "rust", manifest: `{"go":"1.25.13","rust_target":"x86_64-pc-windows-gnu","task_major":3,"golangci_lint":"2.12.2"}`, missing: "rust"},
		{name: "rust target", manifest: `{"go":"1.25.13","rust":"1.82.0","task_major":3,"golangci_lint":"2.12.2"}`, missing: "rust_target"},
		{name: "task major", manifest: `{"go":"1.25.13","rust":"1.82.0","rust_target":"x86_64-pc-windows-gnu","golangci_lint":"2.12.2"}`, missing: "task_major"},
		{name: "golangci-lint", manifest: `{"go":"1.25.13","rust":"1.82.0","rust_target":"x86_64-pc-windows-gnu","task_major":3}`, missing: "golangci_lint"},
	}
